...
\resumeItem{\textbf{Relevant Courses}: Advanced Machine Learning Systems, Systems Programming (C++), Analysis of Algorithms, Functional Programming (OCaml), Object-Oriented Programming (Java), Intro to Machine Learning, Computer Vision}
