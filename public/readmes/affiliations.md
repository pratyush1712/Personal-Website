...
**Key Technologies:** `Next.js` `TypeScript` `Flask` `Google OR-Tools` `Gale-Shapley` `MongoDB` `GCP` `Cron Jobs` `Vercel` <br/>
<br/>
...
**Key Technologies:** `React.js` `TypeScript` `AWS DynamoDB` `Docker` `Kubernetes` `Express` `GCP` `Flutter` <br/>
<br/>
