...
const pages: Page[] = [
	...
	},
	{
		...
		keywords: ["Pratyush Sudhakar Cornell", "Pratyush Sudhakar Experience", "Pratyush Sudhakar Work Experience", "Pratyush Software Engineer", "Pratyush Software Developer"]
	},
	{
		index: 3, name: "affiliations.md", route: "affiliations", description: "Career and other affiliations of Pratyush at Cornell",
		keywords: ["Pratyush Sudhakar Cornell", "Pratyush Sudhakar Affiliations", "Pratyush Sudhakar Cornell Affiliations", "Pratyush Sudhakar Cornell Career", "Digital Tech Cornell",
			"Wushu Cornell", "Cornell Wushu", "Cornell Wushu Club", "Perfect Match", "Cornell Perfect Match", "Cornell Perfect Match Team", "Cornell Perfect Match Engineering",
		]
	},
	{
		index: 4, name: "projects.md", route: "projects", description: "Projects undertaken by Pratyush",
		keywords: ["Pratyush Sudhakar Projects", "Pratyush Sudhakar Cornell Projects", "Pratyush Sudhakar Software Projects", "Pratyush Sudhakar Software Engineering Projects"]
	},
	{
